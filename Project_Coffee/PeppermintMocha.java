...
public class PeppermintMocha extends Coffee {
    ...
    private int peppermintSyrubAmount;//additional member variable
    //constructor
    public PeppermintMocha() {
        super("Peppermint Mocha", 9.5);
        peppermintSyrubAmount = 20;
    }
    
    //getter and setter for member variable
    public int getPeppermintSyrubAmount() {
        return peppermintSyrubAmount;
    }
    public void setPeppermintSyrubAmount(int amount){
        this.peppermintSyrubAmount = amount;
    }
